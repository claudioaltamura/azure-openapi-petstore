...
public interface DefaultApi {
    ...
    String PATH_DELETE_PET = "/pets/{id}";
    /**
     * DELETE /pets/{id}
    ...
    @RequestMapping(
        ...
        value = DefaultApi.PATH_DELETE_PET,
        produces = { "application/json" }
    )
    ...
    String PATH_FIND_PET_BY_ID = "/pets/{id}";
    /**
     * GET /pets/{id}
    ...
    @RequestMapping(
        ...
        value = DefaultApi.PATH_FIND_PET_BY_ID,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = DefaultApi.PATH_FIND_PETS,
        produces = { "application/json" }
    )
    ResponseEntity<List<Pet>> findPets(
        ...
        @Parameter(name = "limit", description = "maximum number of results to return", in = ParameterIn.QUERY) @Valid @RequestParam(value = "limit", required = false) @Nullable Integer limit
    );
